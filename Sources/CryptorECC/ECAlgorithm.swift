...
struct ECAlgorithm {
    ...
    #else
    /// Secure Hash Algorithm 2 256-bit
    static let sha256 = ECAlgorithm(hashLength: CC_LONG(CC_SHA256_DIGEST_LENGTH),
    ...
    #else
    /// Secure Hash Algorithm 2 384-bit
    static let sha384 = ECAlgorithm(hashLength: CC_LONG(CC_SHA384_DIGEST_LENGTH),
    ...
    #else
    /// Secure Hash Algorithm 512-bit
    static let sha512 = ECAlgorithm(hashLength: CC_LONG(CC_SHA512_DIGEST_LENGTH),
